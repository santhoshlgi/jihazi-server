...
class BuyXGetNOfYFixedDiscount extends \Mexbs\Bogo\Model\Rule\Action\Details\BuyXGetYAbstract{

    const SIMPLE_ACTION = 'buy_x_get_n_of_different_y_fixed_discount_action';
    protected $type = 'Mexbs\Bogo\Model\Rule\Action\Details\BuyXGetNOfYFixedDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getYHtml =  __(
                "Get the %1 first %2 items [label for upsell cart hints - singular: %3, plural: %4] for which %5 of the following conditions are %6, with %7%8 discount",
