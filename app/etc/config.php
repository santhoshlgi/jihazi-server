...
return [
    'modules' => [
        ...
        'Aellontech_YesnoCategoryAttributes' => 1,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Amazonpaymentservices_Fort' => 1,
        'Aramex_Shipping' => 1,
        'Brandung_CashOnDeliveryFee' => 0,
        'Custom_Api' => 1,
        'Dangs_WhatsAppChat' => 1,
        ...
        'Magepow_Quickedit' => 1,
        'Magepow_RecentlyViewed' => 1,
        'Magepow_SpeedOptimizer' => 1,
        'Magepow_Stickycart' => 1,
        'Magepow_Theme' => 1,
        'Mageprince_Paymentfee' => 1,
